work <- tribble(
  ...
  "Senior Software Engineer", "Bosch", "January", 2024, "Present", NA, "Campinas, Brazil - Remote", "Working as Senior Software Engineer using React, Java, Selenium, Cypress, Playwright",
