...
edu <- tribble(
  ...
  NA, 2012, 2020, "Universidade de São Paulo", "Ribeirão Preto, São Paulo, Brazil", "Gained expertise in data analysis using R, more specifically ggplot2, tidyr, dplyr, bioconductor packages(like limma and GEOQuery), and the creation of dashboards using Shiny.",
  NA, 2012, 2020, "Universidade de São Paulo", "Ribeirão Preto, São Paulo, Brazil", "Also had classes such as Algorithm and Data Structures, Object Orient Programming, Databases and SQL, Machine Learning, Operating Systems and Distributed Systems.",
  NA, 2012, 2020, "Universidade de São Paulo", "Ribeirão Preto, São Paulo, Brazil", "Learn the basics of C, C++, Java and R.",
)
