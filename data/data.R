work <- tribble(
  ...
  "Senior Software Engineer", "Instituto Eldorado", "November", 2025, "Present", NA, "Campinas, Brazil - Remote", "Languages used: Typescript, Python, YAML, shell scripting",
  "Senior Software Engineer", "Instituto Eldorado", "November", 2025, "Present", NA, "Campinas, Brazil - Remote", "Working assigned on Motorola (Lenovo company), leading the architectural evolution and a cross-functional team of six to deliver enterprise product.",
  "Senior Software Engineer", "Instituto Eldorado", "November", 2025, "Present", NA, "Campinas, Brazil - Remote", "Migrated state management to Zustand and data-fetching to TanStack Query.",
  "Senior Software Engineer", "Instituto Eldorado", "November", 2025, "Present", NA, "Campinas, Brazil - Remote", "Pivoted UI architecture to Ant Design and Tailwind CSS 4.",
  "Senior Software Engineer", "Instituto Eldorado", "November", 2025, "Present", NA, "Campinas, Brazil - Remote", "Architected a complex system using @dnd-kit for intuitive device layout configuration.",
  "Senior Software Engineer", "Instituto Eldorado", "November", 2025, "Present", NA, "Campinas, Brazil - Remote", "Bridged the gap between engineering and product stakeholders.",
  "Senior Software Engineer", "Bosch", "January", 2024, "November", 2025, "Campinas, Brazil - Remote", "Languages and frameworks used: Java, Spring, Javascript, React, jQuery, Rust, Selenium, Cypress, Playwright, Jenkins",
  "Senior Software Engineer", "Bosch", "January", 2024, "November", 2025, "Campinas, Brazil - Remote", "Refactored legacy Java codebase to improve maintainability and performance, implementing modern design patterns and best practices in the Spring framework.",
  "Senior Software Engineer", "Bosch", "January", 2024, "November", 2025, "Campinas, Brazil - Remote", "Integrated Spring backend services with high-performance Rust components for specialized processing.",
  "Senior Software Engineer", "Bosch", "January", 2024, "November", 2025, "Campinas, Brazil - Remote", "Modernized legacy frontend by embedding React components into an existing jQuery architecture, bridging legacy systems with modern reactive interfaces.",
  "Senior Software Engineer", "Bosch", "January", 2024, "November", 2025, "Campinas, Brazil - Remote", "Adapted and implemented enterprise design system from ETAS (Bosch company), standardizing UI components and enhancing user experience (UX).",
  "Senior Software Engineer", "Bosch", "January", 2024, "November", 2025, "Campinas, Brazil - Remote", "Designed automated testing strategies for legacy components and authored comprehensive E2E integration tests using Selenium, Cypress, and Playwright.",
  "Senior Software Engineer", "Bosch", "January", 2024, "November", 2025, "Campinas, Brazil - Remote", "Conducted rigorous peer code reviews to ensure code quality, architectural consistency, and team-wide engineering excellence.",
  "Senior Software Engineer", "Bosch", "January", 2024, "November", 2025, "Campinas, Brazil - Remote", "Delivered features and bug fixes iterated through SCRUM sprints via Jira, maintaining CI/CD automated pipelines with Jenkins.",
  "Frontend Engineer", "Spocket", "July", 2022, "January", 2024, "Vancouver, Canada - Remote", "Languages used: Javascript, Typescript, Python, YAML",
  ...
  "Software Engineer", "Dasa", "April", 2021, "July", 2022, "São Paulo, Brazil - Remote", "Languages used: Javascript, Typescript, YAML",
  ...
  "Full Stack Engineer", "Softwrap", "August", 2020, "April", 2021, "São Paulo, Brazil - Remote", "Languages used: Javascript and Typescript",
...
skills <- tribble(
  ...
  "Technology", "Javascript", "I've been working with for over 6 years. I've been handling it in the front-end with React 19, using styled-components, Ant Design, TailwindCSS 4 for stylization",
  "Technology", "Javascript", "For state management using Context API, Redux, Redux Toolkit (RTK), Zustand and Immer",
  "Technology", "Javascript", "Used TanStack Query for asynchronous state management and Vite for build tooling",
  "Technology", "Javascript", "Using axios and fetch API for consuming differents backends",
  "Technology", "Javascript", "For unit testing using React Testing Library (RTL), Jest and Vitest",
  ...
  NA, "DevOps", "Using Terraform and Ansible for IaC",
  NA, "DevOps", "Proxmox, LXCs for a virtualized environment",
  NA, "DevOps", "Have my own home server/home lab to deploy my cool stuff",
