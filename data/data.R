...
skills <- tribble(
  ...
  NA, "Rust", "My most used side language to create side and personal projects",
  NA, "Rust", "Using tokio runtime for async",
  NA, "Rust", "Using frameworks like actix-web, axum, gotham and tide",
