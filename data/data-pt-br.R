work <- tribble(
  ...
  "Engenheiro Frontend", "Spocket", "Julho", 2022, "Janeiro", 2024, "Canadá - Remoto", "Trabalhando como Engenheiro Frontend utilizando React e seu ecossistema (CRA, Next.js, usando ES6+, React Hooks, React Query, Redux, Context API, Jest, RTL e nosso sistema de design)",
