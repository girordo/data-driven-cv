work <- tribble(
  ...
  "Engenheiro Frontend", "Spocket", "Julho", 2022, "Presente", NA, "Canadá - Remoto", "Refatorei componentes antigos para ES6+ (de componentes de classe para componentes funcionais).",
